// @ts-nocheck
/**
 * Hyperspeed dari React Bits, dikonversi ke TypeScript.
 *
 * Catatan konversi: file ini isinya implementasi Three.js/postprocessing yang
 * sangat imperatif (banyak class internal: App, Road, CarLights,
 * LightsSticks) yang ditulis vendor sebagai JS murni tanpa tipe. Daripada
 * menulis ulang ratusan baris jadi strict-typed (berisiko salah dan ga
 * menambah manfaat karena ini kode vendor, bukan yang akan sering diubah),
 * dipakai `@ts-nocheck` khusus untuk internal file ini. Prop `effectOptions`
 * di komponen luarnya tetap di-export dengan tipe yang jelas (lihat
 * `EffectOptions` di bawah), jadi tetap dapat type-safety & autocomplete
 * normal saat dipakai dari file lain.
 */
'use client';
