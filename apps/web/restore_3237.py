...
with open('src/components/ThreeFloatingObjects.tsx', 'r', encoding='utf-8') as f:
    three_content = f.read()
            ...
            if entry.get('type') == 'PLANNER_RESPONSE' and 'tool_calls' in entry:
                for call in entry['tool_calls']:
                    if call['name'] == 'multi_replace_file_content':
                        ...
                        elif 'ThreeFloatingObjects.tsx' in target:
                            three_content = apply_replacements(three_content, chunks)
                        ...
                        if 'page.tsx' in target:
                            ...
                            three_content = apply_replacements(three_content, [chunk])
...
with open('src/components/ThreeFloatingObjects.tsx', 'w', encoding='utf-8') as f:
    f.write(three_content)

print('Files successfully restored to step 3237!')
